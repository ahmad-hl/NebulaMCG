...
nebula_br = (nebula_br.groupby(['seconds']).agg({'channelrate':'mean','sourcerate':'mean','redundancyrate':'mean'}).reset_index())
...
nebula_br['redundancyrate'] = nebula_br['redundancyrate'].apply(lambda x: x/1024 )
